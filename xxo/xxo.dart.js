...
(function dartProgram() {
  ...
  R = {
    ...
    main: function() {
      ...
      t1 = type$.Function;
      window.turn = P.allowInterop(new R.main_closure0(game), t1);
      window.clear = P.allowInterop(new R.main_closure1(game), t1);
      t1 = document;
      t2 = t1.querySelector("#clear");
      if (t2 != null)
        J.get$onClick$x(t2).forEach$1(0, new R.main_closure2(game));
      t2 = t1.querySelector("#playerX");
      if (t2 != null)
        J.get$onChange$x(t2).forEach$1(0, new R.main_closure3(game));
      t1 = t1.querySelector("#playerO");
      if (t1 != null)
        J.get$onChange$x(t1).forEach$1(0, new R.main_closure4(game));
    },
  ...
  R.NonEmptyFieldException.prototype = {};
  R.OutOfBoundException.prototype = {};
  R.WebGame.prototype = {
    turn$1: function(index) {
      var t2, _this = this,
        t1 = _this.board;
      ...
      if (t1.get$remaining() === 0 || !J.$eq$(t1.get$winner(), $.$get$Board_empty()))
        ...
        P.Future_Future$delayed($.$get$delay(), _this.get$checkAI(), type$.dynamic);
    },
    initNewGame$0: function() {
    ...
    checkAI$0: function() {
      ...
      if (t1) {
        ...
        _this.turn$1(t1.y * 3 + t1.x);
      }
    }
  };
  R.main_closure.prototype = {
    call$1: function(element) {
      type$.MouseEvent._as(element);
      return this.game.turn$1(this.i);
    },
    $signature: 6
  };
  R.main_closure0.prototype = {
    call$1: function(cell) {
      return this.game.turn$1(H._asInt(cell));
    },
    $signature: 22
  };
  ...
  R.main_closure3.prototype = {
    call$1: function(element) {
      return P.Future_Future$delayed($.$get$delay(), this.game.get$checkAI(), type$.dynamic);
    },
    $signature: 1
  };
  R.main_closure4.prototype = {
    call$1: function(element) {
      return P.Future_Future$delayed($.$get$delay(), this.game.get$checkAI(), type$.dynamic);
    },
    $signature: 1
