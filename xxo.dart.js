...
(function dartProgram() {
  ...
  A.Board.prototype = {
    ...
    get$remaining() {
      ...
      t2 = new A.WhereIterable(t1, t2._eval$1("bool(1)")._as(new A.Board_remaining_closure()), t2._eval$1("WhereIterable<1>"));
  ...
  A.Game.prototype = {
    ...
    foldLinesToEmptyAndOwn$3(select, line, player) {
      var positions, t1, t2, empties, owns;
      ...
      t2 = positions.super$Iterable$where(0, t1._as(new A.Game_foldLinesToEmptyAndOwn_closure0()));
      empties = t2.get$length(t2);
      t1 = positions.super$Iterable$where(0, t1._as(new A.Game_foldLinesToEmptyAndOwn_closure1(player)));
      owns = t1.get$length(t1);
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "SyncQueue__delay", "$get$SyncQueue__delay", () => A.Duration$(0, 333));
  })();
