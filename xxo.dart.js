...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    Stream_Stream$periodic(period, computation, $T) {
      var _null = null,
      ...
      controller.set$onListen(new A.Stream_Stream$periodic_closure(new A.Stopwatch(), computation, controller, $T, period));
    ...
    Stream_Stream$periodic_closure: function Stream_Stream$periodic_closure(t0, t1, t2, t3, t4) {
      var _ = this;
      _.watch = t0;
      _.computation = t1;
      _.controller = t2;
    ...
    Stream_Stream$periodic_closure_sendEvent: function Stream_Stream$periodic_closure_sendEvent(t0, t1, t2, t3, t4) {
      var _ = this;
      _._box_0 = t0;
      _.watch = t1;
      _.computation = t2;
    ...
    Stream_Stream$periodic__closure: function Stream_Stream$periodic__closure(t0) {
      this._box_0 = t0;
    },
    Stream_Stream$periodic__closure0: function Stream_Stream$periodic__closure0(t0, t1) {
      this._box_0 = t0;
      this.watch = t1;
    },
    Stream_Stream$periodic__closure1: function Stream_Stream$periodic__closure1(t0, t1, t2, t3) {
      var _ = this;
      _._box_0 = t0;
      _.watch = t1;
      _.period = t2;
    ...
    Stream_Stream$periodic___closure: function Stream_Stream$periodic___closure(t0, t1, t2) {
      this._box_0 = t0;
      this.period = t1;
      this.sendEvent = t2;
    },
    ...
    Player$_(symbol) {
      return new A.Player(symbol);
    },
    Game_convert(key, value) {
      A._asInt(key);
      type$.List_List_int._as(value);
      return new A.MapEntry(new A.Pos(B.JSInt_methods.$mod(key, 3), B.JSInt_methods._tdivFast$1(key, 3)), J.map$1$1$ax(value, A.xxo_Game_listToPos$closure(), type$.List_Pos), type$.MapEntry_of_Pos_and_Iterable_List_Pos);
    },
    Game_listToPos(e) {
      var t1, t2, t3;
      type$.List_int._as(e);
      ...
      t2 = t1.$index(e, 0);
      t3 = B.JSInt_methods.$mod(t2, 3);
      t2 = B.JSInt_methods._tdivFast$1(t2, 3);
      t1 = t1.$index(e, 1);
      return A._setArrayType([new A.Pos(t3, t2), new A.Pos(B.JSInt_methods.$mod(t1, 3), B.JSInt_methods._tdivFast$1(t1, 3))], type$.JSArray_Pos);
    },
    ...
    Board_toString_closure: function Board_toString_closure() {
    },
    Game: function Game() {
    },
    Game_adjust_closure: function Game_adjust_closure(t0, t1) {
      this.$this = t0;
      this.player = t1;
    },
    Game_retainLinesWithEmptyAndOwnField_closure: function Game_retainLinesWithEmptyAndOwnField_closure(t0, t1) {
      this.$this = t0;
      this.player = t1;
    },
    Game_foldLinesToEmptyAndOwn_closure: function Game_foldLinesToEmptyAndOwn_closure(t0) {
      this.$this = t0;
    },
    Game_foldLinesToEmptyAndOwn_closure0: function Game_foldLinesToEmptyAndOwn_closure0() {
    },
    Game_foldLinesToEmptyAndOwn_closure1: function Game_foldLinesToEmptyAndOwn_closure1(t0) {
      this.player = t0;
    },
    Game_bestMove_closure: function Game_bestMove_closure() {
    },
    NonEmptyFieldException: function NonEmptyFieldException() {
    },
    OutOfBoundException: function OutOfBoundException() {
    },
    WebGame$(board, playerX, playerO) {
      var t3,
        t1 = A.List_List$filled(A.ListQueue__calculateCapacity(null), null, false, type$.nullable_Function),
        t2 = type$.JSArray_Pos;
      t2 = A._setArrayType([A._setArrayType([new A.Pos(0, 0), new A.Pos(0, 1), new A.Pos(0, 2)], t2), A._setArrayType([new A.Pos(1, 0), new A.Pos(1, 1), new A.Pos(1, 2)], t2), A._setArrayType([new A.Pos(2, 0), new A.Pos(2, 1), new A.Pos(2, 2)], t2), A._setArrayType([new A.Pos(0, 0), new A.Pos(1, 0), new A.Pos(2, 0)], t2), A._setArrayType([new A.Pos(0, 1), new A.Pos(1, 1), new A.Pos(2, 1)], t2), A._setArrayType([new A.Pos(0, 2), new A.Pos(1, 2), new A.Pos(2, 2)], t2), A._setArrayType([new A.Pos(0, 0), new A.Pos(1, 1), new A.Pos(2, 2)], t2), A._setArrayType([new A.Pos(0, 2), new A.Pos(1, 1), new A.Pos(2, 0)], t2)], type$.JSArray_List_Pos);
      t3 = $.$get$Game_rand().nextBool$0() ? playerX : playerO;
      t2 = new A.WebGame(t3, new A.SyncQueue(new A.ListQueue(t1, type$.ListQueue_Function)), t2, board, playerX, playerO);
      t2.WebGame$3(board, playerX, playerO);
      return t2;
    },
    main() {
      var t1 = A.WebGame$(new A.Board(A.List_List$filled(9, $.$get$Board_empty(), false, type$.Player)), $.$get$Player__x(), $.$get$Player__o());
      t1.initNewGame$0();
      return t1;
    },
    ...
    WebGame_closure: function WebGame_closure(t0, t1) {
      this.$this = t0;
      this.i = t1;
    },
    WebGame_closure0: function WebGame_closure0(t0) {
      this.$this = t0;
    },
    WebGame_closure1: function WebGame_closure1(t0) {
      this.$this = t0;
    },
    SyncQueue: function SyncQueue(t0) {
      this._queue = t0;
      this.__SyncQueue__listener_FI = this.__SyncQueue__timer_FI = $;
    },
    printString(string) {
  ...
  A.Stream.prototype = {
    forEach$1(_, action) {
      ...
      A._instanceType(this)._eval$1("~(1)")._as(action);
  ...
  A.Stream_Stream$periodic_closure.prototype = {
    call$0() {
      var t2, t3, t4, t5, _this = this, t1 = {};
      t1.computationCount = 0;
      t2 = _this.watch;
      t3 = _this.controller;
      t4 = new A.Stream_Stream$periodic_closure_sendEvent(t1, t2, _this.computation, t3, _this.T);
      t5 = _this.period;
      t1.timer = A.Timer_Timer$periodic(t5, t4);
      t3.set$onCancel(new A.Stream_Stream$periodic__closure(t1));
      t3.set$onPause(0, new A.Stream_Stream$periodic__closure0(t1, t2));
      t3.set$onResume(new A.Stream_Stream$periodic__closure1(t1, t2, t5, t4));
    },
    $signature: 0
  };
  A.Stream_Stream$periodic_closure_sendEvent.prototype = {
    call$1(_) {
      var $event, e, s, exception, error, stackTrace, _this = this,
        t1 = _this.watch,
        t2 = t1._stop;
      t1._start = t2 == null ? $.Primitives_timerTicks.call$0() : t2;
      t1 = _this.computation;
      if (t1 != null) {
        $event = null;
        try {
          $event = t1.call$1(_this._box_0.computationCount++);
        } catch (exception) {
          e = A.unwrapException(exception);
          s = A.getTraceFromException(exception);
          t1 = _this.controller;
          t2 = type$.Object;
          error = t2._as(e);
          stackTrace = type$.nullable_StackTrace._as(s);
          A.checkNotNullable(error, "error", t2);
          if (t1._state >= 4)
          ...
          t2 = t1._state;
          if ((t2 & 1) !== 0)
            t1.get$_subscription()._addError$2(error, stackTrace);
          else if ((t2 & 3) === 0)
        ...
        _this.T._as(null);
        _this.controller.add$1(0, null);
      }
    },
    $signature: 8
  };
  A.Stream_Stream$periodic__closure.prototype = {
    call$0() {
  ...
  A.Stream_Stream$periodic__closure1.prototype = {
    call$0() {
      var t2, _this = this,
        t1 = _this.watch,
        elapsed = A.Duration$(t1.get$elapsedMicroseconds(), 0),
        $stop = t1._stop;
      if ($stop != null) {
        t1._start = t1._start + ($.Primitives_timerTicks.call$0() - $stop);
        t1._stop = null;
      }
      t1 = _this.period;
      t2 = _this._box_0;
      t2.timer = A.Timer_Timer(new A.Duration(t1._duration - elapsed._duration), new A.Stream_Stream$periodic___closure(t2, t1, _this.sendEvent));
    },
    $signature: 0
  };
  A.Stream_Stream$periodic___closure.prototype = {
    call$0() {
      var t1 = this.sendEvent;
      this._box_0.timer = A.Timer_Timer$periodic(this.period, t1);
      t1.call$1(null);
    },
    $signature: 0
  };
  ...
  A._StreamController.prototype = {
    ...
    add$1(_, value) {
      ...
      if ((t2 & 1) !== 0) {
        t1._precomputed1._as(value);
        _this.get$_subscription()._async$_add$1(value);
      } else if ((t2 & 3) === 0)
    ...
    _subscribe$4(onData, onError, onDone, cancelOnError) {
      ...
      type$.void_Function._as(t7);
      subscription = new A._ControllerSubscription(_this, t5, t6, t2, t3 | t4, t1._eval$1("_ControllerSubscription<1>"));
  ...
  A.MapEntry.prototype = {
    toString$0(_) {
      return "MapEntry(" + this.key.toString$0(0) + ": " + this.value.toString$0(0) + ")";
    }
  };
  A.Null.prototype = {
    get$hashCode(_) {
  ...
  A._JSSecureRandom.prototype = {
    ...
    nextBool$0() {
      var t1 = this._buffer;
      crypto.getRandomValues(A.NativeUint8List_NativeUint8List$view(t1.buffer, 0, 1));
  ...
  A.Pos.prototype = {
    ...
    get$hashCode(_) {
      return B.JSInt_methods.$shl(this.y, 4 + this.x);
    },
    $eq(_, other) {
      if (other == null)
        return false;
      return other instanceof A.Pos && other.x === this.x && other.y === this.y;
    }
  };
  A.Player.prototype = {
    toString$0(_) {
    ...
    get$hashCode(_) {
      return B.JSString_methods.get$hashCode(this.symbol);
    },
    $eq(_, other) {
      if (other == null)
        return false;
      return other instanceof A.Player && other.symbol === this.symbol;
    }
  };
  A.Board.prototype = {
    get$winner() {
    ...
    get$remaining() {
      ...
      return new A.WhereIterable(t1, t2._eval$1("bool(1)")._as(new A.Board_remaining_closure()), t2._eval$1("WhereIterable<1>")).get$length(0);
    },
    $indexSet(_, xy, p) {
      var t2, t3, t4,
        t1 = xy.x;
      if (t1 < 3)
        ...
        t2 = true;
      if (t2)
        throw A.wrapException(new A.OutOfBoundException());
      t2 = this._fields;
      t1 = xy.y * 3 + t1;
      if (!(t1 >= 0 && t1 < 9))
      ...
      t3 = t3.symbol;
      if (t4.symbol !== t3)
        throw A.wrapException(new A.NonEmptyFieldException());
      B.JSArray_methods.$indexSet(t2, t1, p);
    },
    toString$0(_) {
      var t1, i, line, t2, t3, t4;
      for (t1 = this._fields, i = 0, line = 3, t2 = ""; i < 3; ++i, --line, t2 = t4) {
        t3 = line * 3;
        t3 = B.JSArray_methods.sublist$2(t1, t3 - 3, t3);
        t4 = A._arrayInstanceType(t3);
        t4 = t2 + (" " + line + " | " + new A.MappedListIterable(t3, t4._eval$1("String(1)")._as(new A.Board_toString_closure()), t4._eval$1("MappedListIterable<1,String>")).join$1(0, " | ") + "\n") + "---\xb7---\xb7---\xb7---\n";
      }
      t1 = t2 + "   | a | b | c\n";
      return t1.charCodeAt(0) == 0 ? t1 : t1;
    }
  };
  A.Board_remaining_closure.prototype = {
    call$1(e) {
      var t1;
      type$.Player._as(e);
      t1 = $.$get$Board_empty();
      return t1.symbol === e.symbol;
    },
    $signature: 4
  };
  A.Board_toString_closure.prototype = {
    call$1(e) {
      return type$.Player._as(e).symbol;
    },
    $signature: 23
  };
  A.Game.prototype = {
    ...
    getNextPlayer$1(player) {
      var t1 = this.playerO;
      return t1.symbol === player.symbol ? this.playerX : t1;
    },
    adjust$2(selected, player) {
      var adjusted, t1;
      type$.List_Pos._as(selected);
      if (selected.length === 1)
        return selected;
      adjusted = A.List_List$of(selected, true, type$.Pos);
      t1 = A._arrayInstanceType(adjusted)._eval$1("bool(1)")._as(new A.Game_adjust_closure(this, player));
      if (!!adjusted.fixed$length)
        A.throwExpression(A.UnsupportedError$("retainWhere"));
      B.JSArray_methods._removeWhere$2(adjusted, t1, false);
      return adjusted.length === 0 ? selected : adjusted;
    },
    retainLinesWithEmptyAndOwnField$2(element, player) {
      return $.$get$Game_lines().$index(0, element).fold$1$2(0, false, new A.Game_retainLinesWithEmptyAndOwnField_closure(this, player), type$.bool);
    },
    foldLinesToEmptyAndOwn$3(select, line, player) {
      var positions, t1, empties, owns;
      type$.List_Pos._as(line);
      if (select)
        return true;
      positions = J.map$1$1$ax(line, new A.Game_foldLinesToEmptyAndOwn_closure(this), type$.Player);
      t1 = positions.$ti._eval$1("bool(ListIterable.E)");
      empties = positions.super$Iterable$where(0, t1._as(new A.Game_foldLinesToEmptyAndOwn_closure0())).get$length(0);
      owns = positions.super$Iterable$where(0, t1._as(new A.Game_foldLinesToEmptyAndOwn_closure1(player))).get$length(0);
      return empties === 1 && owns === 1;
    },
    bestMove$1(player) {
      var selected, t1, adjusted,
        moves = A._setArrayType([], type$.JSArray_Pos);
      if (this.minimax$2(player, moves) === 0 && moves.length > 1) {
        player.toString$0(0);
        player.toString$0(0);
        selected = A.List_List$from(moves, type$.Pos);
        t1 = A._arrayInstanceType(selected)._eval$1("bool(1)")._as(new A.Game_bestMove_closure());
        if (!!selected.fixed$length)
          A.throwExpression(A.UnsupportedError$("retainWhere"));
        B.JSArray_methods._removeWhere$2(selected, t1, false);
        if (selected.length > 1) {
          t1 = this.board;
          if (t1.get$remaining() > 6) {
            player.toString$0(0);
            t1.get$remaining();
            player.toString$0(0);
            t1 = $.$get$Game_rand().nextInt$1(selected.length);
            if (!(t1 < selected.length))
              return A.ioore(selected, t1);
            return selected[t1];
          }
          adjusted = this.adjust$2(selected, player);
          player.toString$0(0);
          player.toString$0(0);
          A.S(selected);
          t1 = $.$get$Game_rand().nextInt$1(adjusted.length);
          if (!(t1 < adjusted.length))
            return A.ioore(adjusted, t1);
          return adjusted[t1];
        }
      }
      player.toString$0(0);
      t1 = $.$get$Game_rand().nextInt$1(moves.length);
      if (!(t1 < moves.length))
    ...
    minimax$2(player, move) {
      ...
      for (t2 = t1._fields, t4 = _this.playerO, t5 = player.symbol, t6 = _this.playerX, t7 = move != null, bestScore = -1000, i = 0; i < 9; ++i) {
        t8 = B.JSInt_methods.$mod(i, 3);
        t9 = B.JSInt_methods._tdivFast$1(i, 3);
        xy = new A.Pos(t8, t9);
        t8 = t9 * 3 + t8;
        if (!(t8 < 9))
        ...
        t9 = t2[t8].symbol;
        if (t3.symbol === t9) {
          t1.$indexSet(0, xy, player);
          score = -_this.minimax$2(t4.symbol === t5 ? t6 : t4, null);
          B.JSArray_methods.$indexSet(t2, t8, t3);
          if (score > bestScore) {
            if (t7)
              B.JSArray_methods.clear$0(move);
            bestScore = score;
          }
          if (bestScore === score && t7)
            B.JSArray_methods.add$1(move, xy);
        }
      }
      return bestScore;
    }
  };
  A.Game_adjust_closure.prototype = {
    call$1(pos) {
      return this.$this.retainLinesWithEmptyAndOwnField$2(type$.Pos._as(pos), this.player);
    },
    $signature: 9
  };
  A.Game_retainLinesWithEmptyAndOwnField_closure.prototype = {
    call$2(select, line) {
      return this.$this.foldLinesToEmptyAndOwn$3(A._asBool(select), type$.List_Pos._as(line), this.player);
    },
    $signature: 24
  };
  A.Game_foldLinesToEmptyAndOwn_closure.prototype = {
    call$1(pos) {
      var t1, t2;
      type$.Pos._as(pos);
      t1 = this.$this.board._fields;
      t2 = pos.y * 3 + pos.x;
      if (!(t2 >= 0 && t2 < 9))
        return A.ioore(t1, t2);
      return t1[t2];
  ...
  A.Game_foldLinesToEmptyAndOwn_closure0.prototype = {
    call$1(sym) {
      var t1;
      type$.Player._as(sym);
      t1 = $.$get$Board_empty();
      return t1.symbol === sym.symbol;
    },
    $signature: 4
  };
  A.Game_foldLinesToEmptyAndOwn_closure1.prototype = {
    call$1(sym) {
      type$.Player._as(sym);
      return this.player.symbol === sym.symbol;
    },
    $signature: 4
  };
  A.Game_bestMove_closure.prototype = {
    call$1(e) {
      return B.JSArray_methods.contains$1(B.List_LlV, type$.Pos._as(e));
    },
    $signature: 9
  };
  A.NonEmptyFieldException.prototype = {$isException: 1};
  A.OutOfBoundException.prototype = {$isException: 1};
  A.WebGame.prototype = {
    WebGame$3(board, playerX, playerO) {
      var i, t1, t2, _i, t3;
      for (i = 0; i < 9; ++i) {
        t1 = document.querySelector("#-cell-" + i);
        if (t1 != null)
          J.get$onClick$x(t1).forEach$1(0, new A.WebGame_closure(this, i));
      }
      t1 = document;
      t2 = t1.querySelector("#clear");
      if (t2 != null)
        J.get$onClick$x(t2).forEach$1(0, new A.WebGame_closure0(this));
      for (t2 = ["X", "O"], _i = 0; _i < 2; ++_i) {
        t3 = t1.querySelector("#player" + t2[_i]);
        if (t3 != null)
          J.get$onChange$x(t3).forEach$1(0, new A.WebGame_closure1(this));
      }
    },
    turn$2(index, ai) {
      ...
      try {
        t1 = _this.board;
        if (t1.get$remaining() !== 0) {
          t2 = t1.get$winner();
          t3 = $.$get$Board_empty();
          t2 = t3.symbol !== t2.symbol;
        } else
          t2 = true;
        if (t2 || ai !== _this.checkAiFlag$1(_this._currentPlayer))
          return;
        t1.$indexSet(0, new A.Pos(B.JSInt_methods.$mod(index, 3), B.JSInt_methods._tdivFast$1(index, 3)), _this._currentPlayer);
        t2 = document.querySelector("#-cell-" + index);
        if (t2 != null)
        ...
        if (t1.get$remaining() !== 0) {
          t1 = t1.get$winner();
          t2 = $.$get$Board_empty();
          t1 = t2.symbol !== t1.symbol;
        } else
          t1 = true;
        if (t1)
          _this.highlight$0(0);
        else if (_this.checkAiFlag$1(_this._currentPlayer))
          _this.queue.queue$1(_this.get$checkAI());
      } catch (exception) {
    ...
    initNewGame$0() {
      ...
      B.JSArray_methods.fillRange$3(_this.board._fields, 0, 9, $.$get$Board_empty());
      for (i = 0; i < 9; ++i) {
        t1 = document.querySelector("#-cell-" + i);
        if (t1 != null) {
    ...
    highlight$0(_) {
      ...
      for (t1 = this.WebGame_lines, t2 = type$.List_Pos, t3 = type$.Pos, t4 = this.board._fields, _i = 0; _i < 8; ++_i) {
        line = t1[_i];
        t2._as(line);
        t5 = line.length;
        if (0 >= t5)
          return A.ioore(line, 0);
        t6 = t3._as(line[0]);
        t6 = t6.y * 3 + t6.x;
        if (!(t6 >= 0 && t6 < 9))
        ...
        if (t5) {
          for (i = 0; i < 3; ++i) {
            ...
            t2 = t1.x;
            t1 = t1.y;
            t1 = document.querySelector("#-cell-" + (t2 + t1 * 3));
            if (t1 != null)
    ...
    checkAI$0() {
      ...
      if (t1)
        return;
      if (_this.checkAiFlag$1(_this._currentPlayer)) {
        t1 = _this.bestMove$1(_this._currentPlayer);
        _this.turn$2(t1.y * 3 + t1.x, true);
      }
    },
    checkAiFlag$1(player) {
      var t1 = type$.InputElement._as(document.querySelector("#player" + player.symbol).querySelector("input")).checked;
      return t1 === true;
    }
  };
  A.WebGame_closure.prototype = {
    call$1(_) {
      type$.MouseEvent._as(_);
      return this.$this.turn$2(this.i, false);
    },
    $signature: 10
  };
  A.WebGame_closure0.prototype = {
    call$1(_) {
      type$.MouseEvent._as(_);
      return this.$this.initNewGame$0();
    },
    $signature: 10
  };
  A.WebGame_closure1.prototype = {
    call$1(_) {
      var t1;
      type$.Event._as(_);
      t1 = this.$this;
      return t1.queue.queue$1(t1.get$checkAI());
    },
    $signature: 3
  };
  A.SyncQueue.prototype = {
    get$_listener() {
      var result, _this = this,
        value = _this.__SyncQueue__listener_FI;
      if (value === $) {
        value = _this.__SyncQueue__timer_FI;
        if (value === $) {
          result = A.Stream_Stream$periodic($.$get$SyncQueue__delay(), _this.get$_period(), type$.int);
          _this.__SyncQueue__timer_FI !== $ && A.throwLateFieldADI("_timer");
          _this.set$__SyncQueue__timer_FI(result);
          value = result;
        }
        result = value.listen$1(_this.get$_OnData());
        _this.__SyncQueue__listener_FI !== $ && A.throwLateFieldADI("_listener");
        _this.set$__SyncQueue__listener_FI(result);
        value = result;
      }
      return value;
    },
    queue$1(f) {
      ...
      type$.dynamic_Function._as(f);
      t1 = document.querySelector("#-game-spinner").style;
      t1.display = "inline-block";
      t1 = this._queue;
      t2 = t1.$ti;
      t2._precomputed1._as(f);
      B.JSArray_methods.$indexSet(t1._table, t1._tail, f);
      t3 = t1._tail;
      t4 = t1._table.length;
      t3 = (t3 + 1 & t4 - 1) >>> 0;
      t1._tail = t3;
    ...
    set$__SyncQueue__timer_FI(__SyncQueue__timer_FI) {
      this.__SyncQueue__timer_FI = type$.Stream_int._as(__SyncQueue__timer_FI);
    },
    set$__SyncQueue__listener_FI(__SyncQueue__listener_FI) {
      this.__SyncQueue__listener_FI = type$.StreamSubscription_int._as(__SyncQueue__listener_FI);
    }
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _instance_0_u(_, "get$_onResume", "_onResume$0", 0);
    _static_2(A, "xxo_Game_convert$closure", "Game_convert", 28);
    _static_1(A, "xxo_Game_listToPos$closure", "Game_listToPos", 29);
    _instance_0_u(A.WebGame.prototype, "get$checkAI", "checkAI$0", 0);
    _instance_1_u(_ = A.SyncQueue.prototype, "get$_period", "_period$1", 26);
    _instance_1_u(_, "get$_OnData", "_OnData$1", 27);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Closure, A.Iterable, A.ListIterator, A.WhereIterator, A.FixedLengthListMixin, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.JSSyntaxRegExp, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A.AsyncError, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A._StreamController, A._SyncStreamControllerDispatch, A._BufferingStreamSubscription, A._DelayedEvent, A._PendingEvents, A._Zone, A.SetBase, A._LinkedHashSetCell, A._LinkedHashSetIterator, A.ListBase, A._ListQueueIterator, A.Duration, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.FormatException, A.MapEntry, A.Null, A._StringStackTrace, A.Stopwatch, A.StringBuffer, A.CssStyleDeclarationBase, A.EventStreamProvider, A._EventStreamSubscription, A.ImmutableListMixin, A.FixedSizeListIterator, A._JSSecureRandom, A.Pos, A.Player, A.Board, A.Game, A.NonEmptyFieldException, A.OutOfBoundException, A.SyncQueue]);
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JavaScriptObject, J.JavaScriptBigInt, J.JavaScriptSymbol, J.JSNumber, J.JSString]);
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, J.JSArray, A.NativeByteBuffer, A.NativeTypedData, A.EventTarget, A._CssStyleDeclaration_JavaScriptObject_CssStyleDeclarationBase, A.DomException, A.DomTokenList, A.Event, A.__NamedNodeMap_JavaScriptObject_ListMixin]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._Future__chainForeignFuture_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_Stream$periodic_closure_sendEvent, A.Stream_forEach_closure0, A.Stream_forEach__closure0, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._EventStreamSubscription_closure, A._EventStreamSubscription_onData_closure, A.CssClassSetImpl_add_closure, A.CssClassSetImpl_removeAll_closure, A.Board_remaining_closure, A.Board_toString_closure, A.Game_adjust_closure, A.Game_foldLinesToEmptyAndOwn_closure, A.Game_foldLinesToEmptyAndOwn_closure0, A.Game_foldLinesToEmptyAndOwn_closure1, A.Game_bestMove_closure, A.WebGame_closure, A.WebGame_closure0, A.WebGame_closure1]);
    _inheritMany(A.Closure0Args, [A.nullFuture_closure, A.Primitives_initTicker_closure, A._AsyncRun__scheduleImmediateJsOverride_internalCallback, A._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, A._TimerImpl_internalCallback, A._TimerImpl$periodic_closure, A._Future__addListener_closure, A._Future__prependListeners_closure, A._Future__chainForeignFuture_closure1, A._Future__asyncCompleteWithValue_closure, A._Future__asyncCompleteError_closure, A._Future__propagateToListeners_handleWhenCompleteCallback, A._Future__propagateToListeners_handleValueCallback, A._Future__propagateToListeners_handleError, A.Stream_Stream$periodic_closure, A.Stream_Stream$periodic__closure, A.Stream_Stream$periodic__closure0, A.Stream_Stream$periodic__closure1, A.Stream_Stream$periodic___closure, A.Stream_forEach_closure, A.Stream_forEach__closure, A.Stream_length_closure0, A._StreamController__subscribe_closure, A._StreamController__recordCancel_complete, A._BufferingStreamSubscription__sendError_sendError, A._PendingEvents_schedule_closure, A._cancelAndError_closure, A._rootHandleError_closure, A._RootZone_bindCallbackGuarded_closure]);
    ...
    _inheritMany(A.ListIterable, [A.MappedListIterable, A.ListQueue]);
    _inherit(A.NullError, A.TypeError);
    _inheritMany(A.TearOffClosure, [A.StaticClosure, A.BoundClosure]);
    _inherit(A._AssertionError, A.AssertionError);
    _inherit(A.JsLinkedHashMap, A.MapBase);
    _inheritMany(A.Closure2Args, [A.initHooks_closure0, A._Future__chainForeignFuture_closure0, A._cancelAndErrorClosure_closure, A.MapBase_mapToString_closure, A.Game_retainLinesWithEmptyAndOwnField_closure]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "Null()", "~(Object,StackTrace)", "~(Event)", "bool(Player)", "~(~())", "int()", "Null(@)", "~(@)", "bool(Pos)", "~(MouseEvent)", "Future<Null>()", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(Object,StackTrace)", "_Future<@>(@)", "_Future<Null>()", "Null(~)", "~(Object?,Object?)", "bool(Set<String>)", "~(Set<String>)", "String(Player)", "bool(bool,List<Pos>)", "Player(Pos)", "int(int)", "~(int)", "MapEntry<Pos,Iterable<List<Pos>>>(int,List<List<int>>)", "List<Pos>(List<int>)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","AElement":"SvgElement","GraphicsElement":"SvgElement","AudioElement":"HtmlElement","MediaElement":"HtmlElement","HtmlDocument":"Node","Document":"Node","Window":"EventTarget","PointerEvent":"MouseEvent","CompositionEvent":"UIEvent","CDataSection":"CharacterData","Text":"CharacterData","MathMLElement":"Element","JSBool":{"bool":[],"TrustedGetRuntimeType":[]},"JSNull":{"Null":[],"TrustedGetRuntimeType":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"ArrayIterator":{"Iterator":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[],"TrustedGetRuntimeType":[]},"JSNumNotInt":{"num":[],"TrustedGetRuntimeType":[]},"JSString":{"String":[],"TrustedGetRuntimeType":[]},"LateError":{"Error":[]},"EfficientLengthIterable":{"Iterable":["1"]},"ListIterable":{"Iterable":["1"]},"ListIterator":{"Iterator":["1"]},"MappedListIterable":{"ListIterable":["2"],"Iterable":["2"],"ListIterable.E":"2","Iterable.E":"2"},"WhereIterable":{"Iterable":["1"],"Iterable.E":"1"},"WhereIterator":{"Iterator":["1"]},"NullError":{"TypeError":[],"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"NullThrownFromJavaScriptException":{"Exception":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"Closure0Args":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"_CyclicInitializationError":{"Error":[]},"RuntimeError":{"Error":[]},"_AssertionError":{"Error":[]},"JsLinkedHashMap":{"MapBase":["1","2"],"LinkedHashMap":["1","2"],"MapBase.K":"1","MapBase.V":"2"},"LinkedHashMapKeyIterable":{"Iterable":["1"],"Iterable.E":"1"},"LinkedHashMapKeyIterator":{"Iterator":["1"]},"NativeByteBuffer":{"TrustedGetRuntimeType":[]},"NativeByteData":{"ByteData":[],"TrustedGetRuntimeType":[]},"NativeTypedArray":{"JavaScriptIndexingBehavior":["1"]},"NativeTypedArrayOfInt":{"ListBase":["int"],"List":["int"],"JavaScriptIndexingBehavior":["int"],"Iterable":["int"],"FixedLengthListMixin":["int"]},"NativeUint8List":{"ListBase":["int"],"List":["int"],"JavaScriptIndexingBehavior":["int"],"Iterable":["int"],"FixedLengthListMixin":["int"],"TrustedGetRuntimeType":[],"ListBase.E":"int"},"_Error":{"Error":[]},"_TypeError":{"TypeError":[],"Error":[]},"_Future":{"Future":["1"]},"_TimerImpl":{"Timer":[]},"AsyncError":{"Error":[]},"_StreamController":{"_StreamControllerLifecycle":["1"],"_EventDispatch":["1"]},"_SyncStreamController":{"_SyncStreamControllerDispatch":["1"],"_StreamController":["1"],"_StreamControllerLifecycle":["1"],"_EventDispatch":["1"]},"_ControllerStream":{"_StreamImpl":["1"],"Stream":["1"]},"_ControllerSubscription":{"_BufferingStreamSubscription":["1"],"StreamSubscription":["1"],"_EventDispatch":["1"]},"_BufferingStreamSubscription":{"StreamSubscription":["1"],"_EventDispatch":["1"]},"_StreamImpl":{"Stream":["1"]},"_DelayedData":{"_DelayedEvent":["1"]},"_DelayedError":{"_DelayedEvent":["@"]},"_Zone":{"Zone":[]},"_RootZone":{"_Zone":[],"Zone":[]},"_LinkedHashSet":{"SetBase":["1"],"Set":["1"],"Iterable":["1"]},"_LinkedHashSetIterator":{"Iterator":["1"]},"ListQueue":{"Queue":["1"],"ListIterable":["1"],"Iterable":["1"],"ListIterable.E":"1","Iterable.E":"1"},"_ListQueueIterator":{"Iterator":["1"]},"SetBase":{"Set":["1"],"Iterable":["1"]},"_SetBase":{"SetBase":["1"],"Set":["1"],"Iterable":["1"]},"int":{"num":[]},"List":{"Iterable":["1"]},"Set":{"Iterable":["1"]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"StateError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"OutOfMemoryError":{"Error":[]},"StackOverflowError":{"Error":[]},"_Exception":{"Exception":[]},"FormatException":{"Exception":[]},"_StringStackTrace":{"StackTrace":[]},"MouseEvent":{"Event":[]},"Node":{"EventTarget":[]},"HtmlElement":{"Element":[],"Node":[],"EventTarget":[]},"AnchorElement":{"Element":[],"Node":[],"EventTarget":[]},"AreaElement":{"Element":[],"Node":[],"EventTarget":[]},"CharacterData":{"Node":[],"EventTarget":[]},"Element":{"Node":[],"EventTarget":[]},"FormElement":{"Element":[],"Node":[],"EventTarget":[]},"InputElement":{"Element":[],"Node":[],"EventTarget":[]},"SelectElement":{"Element":[],"Node":[],"EventTarget":[]},"UIEvent":{"Event":[]},"_NamedNodeMap":{"ListBase":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"Iterable":["Node"],"ImmutableListMixin.E":"Node","ListBase.E":"Node"},"_ElementCssClassSet":{"SetBase":["String"],"Set":["String"],"Iterable":["String"]},"_EventStream":{"Stream":["1"]},"_ElementEventStreamImpl":{"_EventStream":["1"],"Stream":["1"]},"_EventStreamSubscription":{"StreamSubscription":["1"]},"FixedSizeListIterator":{"Iterator":["1"]},"CssClassSetImpl":{"SetBase":["String"],"Set":["String"],"Iterable":["String"]},"AttributeClassSet":{"SetBase":["String"],"Set":["String"],"Iterable":["String"]},"SvgElement":{"Element":[],"Node":[],"EventTarget":[]},"NonEmptyFieldException":{"Exception":[]},"OutOfBoundException":{"Exception":[]},"Uint8List":{"List":["int"],"Iterable":["int"]}}'));
  A._Universe_addErasedTypes(init.typeUniverse, JSON.parse('{"EfficientLengthIterable":1,"NativeTypedArray":1,"_DelayedEvent":1,"_SetBase":1}'));
  var string$ = {
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      ListQueue_Function: findType("ListQueue<Function>"),
      List_List_int: findType("List<List<int>>"),
      List_Pos: findType("List<Pos>"),
      List_int: findType("List<int>"),
      MapEntry_of_Pos_and_Iterable_List_Pos: findType("MapEntry<Pos,Iterable<List<Pos>>>"),
...
;
    ...
    B.Pos_2_2 = new A.Pos(2, 2);
    B.Pos_1_1 = new A.Pos(1, 1);
    B.Pos_0_0 = new A.Pos(0, 0);
    B.Pos_2_0 = new A.Pos(2, 0);
    B.Pos_0_2 = new A.Pos(0, 2);
    B.List_LlV = A._setArrayType(makeConstList([B.Pos_2_2, B.Pos_1_1, B.Pos_0_0, B.Pos_2_0, B.Pos_0_2]), type$.JSArray_Pos);
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "Player__empty", "$get$Player__empty", () => A.Player$_(" "));
    _lazyFinal($, "Player__x", "$get$Player__x", () => A.Player$_("X"));
    _lazyFinal($, "Player__o", "$get$Player__o", () => A.Player$_("O"));
    _lazyFinal($, "Board_empty", "$get$Board_empty", () => $.$get$Player__empty());
    _lazyFinal($, "Game_rand", "$get$Game_rand", () => $.$get$Random__secureRandom());
    _lazyFinal($, "Game_lines", "$get$Game_lines", () => {
      var t1 = A.findType("JSArray<int>"),
        t2 = A.findType("JSArray<List<int>>");
      return A.LinkedHashMap_LinkedHashMap$_literal([0, A._setArrayType([A._setArrayType([3, 6], t1), A._setArrayType([4, 8], t1), A._setArrayType([1, 2], t1)], t2), 1, A._setArrayType([A._setArrayType([0, 2], t1), A._setArrayType([4, 7], t1)], t2), 2, A._setArrayType([A._setArrayType([0, 1], t1), A._setArrayType([4, 6], t1), A._setArrayType([5, 8], t1)], t2), 3, A._setArrayType([A._setArrayType([0, 6], t1), A._setArrayType([4, 5], t1)], t2), 4, A._setArrayType([A._setArrayType([3, 5], t1), A._setArrayType([0, 8], t1), A._setArrayType([1, 7], t1), A._setArrayType([2, 6], t1)], t2), 5, A._setArrayType([A._setArrayType([3, 4], t1), A._setArrayType([2, 8], t1)], t2), 6, A._setArrayType([A._setArrayType([3, 0], t1), A._setArrayType([4, 2], t1), A._setArrayType([7, 8], t1)], t2), 7, A._setArrayType([A._setArrayType([6, 8], t1), A._setArrayType([4, 1], t1)], t2), 8, A._setArrayType([A._setArrayType([6, 7], t1), A._setArrayType([0, 4], t1), A._setArrayType([2, 5], t1)], t2)], type$.int, type$.List_List_int).map$2$1(0, A.xxo_Game_convert$closure(), type$.Pos, A.findType("Iterable<List<Pos>>"));
    });
    _lazyFinal($, "SyncQueue__delay", "$get$SyncQueue__delay", () => A.Duration$(0, 100));
  })();
